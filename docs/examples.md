...
```bash
promptor_config::prompt '[left_half_circle_thick]237 231 %~ [left_hard_divider] {{unwritten}} [left_hard_divider] {{exit_code}} [left_hard_divider] {{git_async}}[right_half_circle_thick]'
promptor_config::rprompt '[left_half_circle_thick]25 231 %n@%m [right_hard_divider] 237 231 %D{%H:%M}[right_half_circle_thick]'
```

<p align="center">
  <img src="images/mix_left_git.drawio.png" >
</p>
...
promptor_config::rprompt '[left_half_circle_thick]{{git_async}} [right_hard_divider] 25 231 %n@%m [right_hard_divider] 237 231 %D{%H:%M}[right_half_circle_thick]'
```

<p align="center">
  <img src="images/mix_right_git.drawio.png" >
</p>